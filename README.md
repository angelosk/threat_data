...
The following are some numbers surrounding Animus activity to date. These stats were last updated on July 25, 2015. All activity 
is fully automated.
* Attacker IP addresses collected: 21739
* Total SSH attempts observed: 35941639
* Unique malware samples captured: 1018
* Malicious domains identified: 429
* Unique passwords collected from sensors: 872466
* Unique usernames collected from sensors: 34329
* SSH library versions observed from SSH bruteforce tools: 198
