...
The following are some numbers surrounding Animus activity to date. These stats were last updated on July 11, 2015. All activity 
is fully automated.
* Attacker IP addresses collected: 20492
* Total SSH attempts observed: 35756139
* Unique malware samples captured: 977
* Malicious domains identified: 401
* Unique passwords collected from sensors: 870300
* Unique usernames collected from sensors: 32816
* SSH library versions observed from SSH bruteforce tools: 191
